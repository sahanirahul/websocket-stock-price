...
# copying config file containing redis db connection details
COPY config/config.local.json config/config.local.json

RUN mkdir logs 

# ENV CONFIGPATH=/app/config/config.local.json ENV=dev LOGDIR=/app/logs PORT=19093 REDIS_ADDRESS=
